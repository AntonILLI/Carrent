						...
						<div class="row align-items-center single-model item">
							<div class="col-lg-6 model-left">
								<div class="title justify-content-between d-flex">
									<h4 class="mt-20"><?php echo $row['name'];?></h4>
									<h2><?php echo '$'.$row['price'];?><span>/day</span></h2>
								</div>
								<p>
								...
								<p>
									...
									Doors            : <?php echo $row['Doors'] ?> <br>
									Air Condition    : <?php echo $row['AC'] ?> <br>
									Transmission     : <?php echo $row['Transmission'] ?>
								</p>
								<a class="text-uppercase primary-btn" href="#">Book This Car Now</a>
							</div>
							<div class="col-lg-6 model-right">
								<?php echo '<img class="img-fluid" src="'.$row['image'].'" alt="">' ?>
							</div>
						</div>
						<?php endwhile; ?>
					</div>
