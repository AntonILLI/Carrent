...
<header id="main-header" class="py-2 bg-secondary text-white">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8">
          <h1>
            <i class="fas fa-user"></i>Car Detail</h1>
        </div>
...
$id = $_GET['id'];
 $result = $mysqli->query("SELECT * FROM rentcar WHERE id=$id") or die($mysqli->error);
 }
...
<div class="card mt-5 mb-3" style="max-width: 1000px;">
  <div class="row no-gutters">
    <div class="col-md-3">
    <img class="card-img"src='<?php echo $row['image']?>' height='200' width='100'></td>
    </div>
    <div class="col-md-9">
