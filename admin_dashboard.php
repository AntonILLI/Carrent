...
<?php
  ...
  $msg_sql = $mysqli->query("SELECT COUNT(id) FROM contact_table") or die($mysqli->error);
?>
          ...
          <div class="card">
            ...
            <table class="table table-striped">
              ...
              while ($row = $result->fetch_assoc()) :
                ...
                <tbody>
                  <tr>
                    <td><img src='<?php echo $row['image'];?>' height='80' width='120'></td>
