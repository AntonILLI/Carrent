<?php include "admin_header.php" ?>
        ...
        $result = $mysqli->query("SELECT COUNT(*) FROM users") or die($mysqli->error);
        ...
        // $sql .= "OFFSET $$offset";
        $sql = "SELECT * FROM users LIMIT $offset, $set_per_page";
        $result_row = $mysqli->query($sql) or die($mysqli->error);
              ...
              while ($row = $result_row->fetch_assoc()) :
                ...
                <tbody>
                  <tr>
                    ...
                    <td><img src="img/pages/t1.jpg" height="100" width="150"></td>
                    <td><?php echo $row['firstname'].' '.$row['lastname']; ?></td>
                    <td><?php echo $row['email']; ?></td>
                    <td> <a href="user_process.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger mt-4" style="float:right;">Delete</a></td>
